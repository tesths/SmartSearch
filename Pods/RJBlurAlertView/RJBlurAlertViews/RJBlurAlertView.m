...
/*Default Colors*/
#define RJTitleLabelBackgroundColor [UIColor colorWithRed:25/255.0 green:34/255.0 blue:50/255.0 alpha:1]
#define RJComfirmButtonColor [UIColor colorWithRed:25/255.0 green:34/255.0 blue:50/255.0 alpha:1]
...
- (void)_labelSetupWithTitle:(NSString*) title andText:(NSString*) text
{
    ...
    _titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-LightItalic" size:16];
...
- (void)_buttonSetupWithCancelButton:(BOOL) hasCancelButton
{
    ...
    _okButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:14];
