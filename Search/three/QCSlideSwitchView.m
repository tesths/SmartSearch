...
- (void)initValues
{
    ...
    UIImageView *line = [[UIImageView alloc] initWithFrame:CGRectMake(0, kHeightOfTopScrollView-1, self.bounds.size.width, 1)];
    line.backgroundColor = [UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1];
    
    UIImageView *verticalline1 = [[UIImageView alloc] initWithFrame:CGRectMake(SCREENWIDTH/4, 2, 1, kHeightOfTopScrollView - 4)];
    verticalline1.backgroundColor = [UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1];
    UIImageView *verticalline2 = [[UIImageView alloc] initWithFrame:CGRectMake(SCREENWIDTH/4*2, 2, 1, kHeightOfTopScrollView - 4)];
    verticalline2.backgroundColor = [UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1];
    UIImageView *verticalline3 = [[UIImageView alloc] initWithFrame:CGRectMake(SCREENWIDTH/4*3, 2, 1, kHeightOfTopScrollView - 4)];
    verticalline3.backgroundColor = [UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1];
    
    
    [_topScrollView addSubview:line];
    [_topScrollView addSubview:verticalline1];
    [_topScrollView addSubview:verticalline2];
    [_topScrollView addSubview:verticalline3];
...
//            _rigthSideButton.frame = CGRectMake(self.bounds.size.width - self.rigthSideButton.bounds.size.width, 0, _rigthSideButton.bounds.size.width, _topScrollView.bounds.size.height);
            ...
            _rigthSideButton.frame = CGRectMake(0, 0, _rigthSideButton.bounds.size.width, _topScrollView.bounds.size.height);
...
- (void)createNameButtons
{
    ...
    for (int i = 0; i < [_viewArray count]; i++) {
        ...
        //计算下一个tab的x偏移量
        xOffset += self.bounds.size.width / [_viewArray count] + kWidthOfButtonMargin;
        
        [button setTag:i+100];
        if (i == 0) {
            _shadowImageView.frame = CGRectMake(kWidthOfButtonMargin, 0, self.bounds.size.width / [_viewArray count], _shadowImage.size.height);
            button.selected = YES;
        }
