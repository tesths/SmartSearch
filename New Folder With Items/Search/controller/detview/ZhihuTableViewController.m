...
@interface ZhihuTableViewController ()

@end

@implementation ZhihuTableViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    [self.tableView addFooterWithTarget:self action:@selector(loadZhihu)];
...
- (void)StartSearch
{
    ...
    [[SearchApi searchzhihu:self.searchstr] subscribeNext:^(id value) {
